...
typedef struct __mavlink_wind_cov_t {
 ...
 float wind_z; /*< [m/s] Wind in down (NED) direction (NAN if unknown)
            */
 float var_horiz; /*< [m/s] Variability of wind in XY, 1-STD estimated
                from a 1 Hz lowpassed wind estimate (NAN if unknown)
            */
 float var_vert; /*< [m/s] Variability of wind in Z, 1-STD estimated from
                a 1 Hz lowpassed wind estimate (NAN if unknown)
            */
 float wind_alt; /*< [m] Altitude (MSL) that this measurement was taken
                at (NAN if unknown)
            */
 float horiz_accuracy; /*< [m/s] Horizontal speed 1-STD accuracy (0 if
                unknown)
            */
 float vert_accuracy; /*< [m/s] Vertical speed 1-STD accuracy (0 if
                unknown)
            */
} mavlink_wind_cov_t;
 ...
 * @param var_horiz [m/s] Variability of wind in XY, 1-STD estimated
                from a 1 Hz lowpassed wind estimate (NAN if unknown)
            
 * @param var_vert [m/s] Variability of wind in Z, 1-STD estimated from
                a 1 Hz lowpassed wind estimate (NAN if unknown)
            
 * @param wind_alt [m] Altitude (MSL) that this measurement was taken
                at (NAN if unknown)
            
 * @param horiz_accuracy [m/s] Horizontal speed 1-STD accuracy (0 if
                unknown)
            
 * @param vert_accuracy [m/s] Vertical speed 1-STD accuracy (0 if
                unknown)
 ...
 *
 * @return [m/s] Variability of wind in XY, 1-STD estimated
                from a 1 Hz lowpassed wind estimate (NAN if unknown)
 ...
 *
 * @return [m/s] Variability of wind in Z, 1-STD estimated from
                a 1 Hz lowpassed wind estimate (NAN if unknown)
 ...
 *
 * @return [m] Altitude (MSL) that this measurement was taken
                at (NAN if unknown)
 ...
 *
 * @return [m/s] Horizontal speed 1-STD accuracy (0 if
                unknown)
 ...
 *
 * @return [m/s] Vertical speed 1-STD accuracy (0 if
                unknown)
