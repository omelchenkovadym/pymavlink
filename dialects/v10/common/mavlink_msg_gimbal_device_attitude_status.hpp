 ...
 * Message reporting the status of a gimbal device.
                ...
                If the flag GIMBAL_DEVICE_FLAGS_YAW_IN_VEHICLE_FRAME is set, then they are relative to the vehicle
                heading (vehicle frame).
                If the flag GIMBAL_DEVICE_FLAGS_YAW_IN_EARTH_FRAME is set, then they are relative to absolute North
                (earth frame).
                ...
                If neither the GIMBAL_DEVICE_FLAGS_YAW_IN_VEHICLE_FRAME nor the GIMBAL_DEVICE_FLAGS_YAW_IN_EARTH_FRAME
                flag is set,
...
struct GIMBAL_DEVICE_ATTITUDE_STATUS : mavlink::Message {
    ...
    uint16_t flags; /*<  Current gimbal flags set.
             */
    std::array<float, 4> q; /*<  Quaternion components, w, x, y, z (1 0 0 0 is the null-rotation). The frame
