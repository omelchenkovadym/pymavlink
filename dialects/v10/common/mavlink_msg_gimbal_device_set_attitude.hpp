 ...
 * Low level message to control a gimbal device's attitude.
                ...
                Setting both GIMBAL_DEVICE_FLAGS_YAW_IN_VEHICLE_FRAME and GIMBAL_DEVICE_FLAGS_YAW_IN_EARTH_FRAME is not
                allowed.
...
struct GIMBAL_DEVICE_SET_ATTITUDE : mavlink::Message {
    ...
    uint16_t flags; /*<  Low level gimbal flags.
             */
    std::array<float, 4> q; /*<  Quaternion components, w, x, y, z (1 0 0 0 is the
