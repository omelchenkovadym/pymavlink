...
typedef struct __mavlink_resource_request_t {
 uint8_t request_id; /*<  Request ID. This ID should be re-used when sending back URI
                contents
            */
 uint8_t uri_type; /*<  The type of requested URI. 0 = a file via URL. 1 = a UAVCAN binary
            */
 uint8_t uri[120]; /*<  The requested unique resource identifier (URI). It is not necessarily
                a straight domain name (depends on the URI type enum)
            */
 uint8_t transfer_type; /*<  The way the autopilot wants to receive the URI. 0 = MAVLink FTP.
                1 = binary stream.
            */
 uint8_t storage[120]; /*<  The storage path the autopilot wants the URI to be stored in. Will
                only be valid if the transfer_type has a storage associated (e.g. MAVLink FTP).
            */
 ...
 *
 * @param request_id  Request ID. This ID should be re-used when sending back URI
                contents
            
 * @param uri_type  The type of requested URI. 0 = a file via URL. 1 = a UAVCAN binary
            
 * @param uri  The requested unique resource identifier (URI). It is not necessarily
                a straight domain name (depends on the URI type enum)
            
 * @param transfer_type  The way the autopilot wants to receive the URI. 0 = MAVLink FTP.
                1 = binary stream.
            
 * @param storage  The storage path the autopilot wants the URI to be stored in. Will
                only be valid if the transfer_type has a storage associated (e.g. MAVLink FTP).
 ...
 *
 * @return  Request ID. This ID should be re-used when sending back URI
                contents
 ...
 *
 * @return  The requested unique resource identifier (URI). It is not necessarily
                a straight domain name (depends on the URI type enum)
 ...
 *
 * @return  The way the autopilot wants to receive the URI. 0 = MAVLink FTP.
                1 = binary stream.
 ...
 *
 * @return  The storage path the autopilot wants the URI to be stored in. Will
                only be valid if the transfer_type has a storage associated (e.g. MAVLink FTP).
