...
struct ONBOARD_COMPUTER_STATUS : mavlink::Message {
    ...
    uint8_t type; /*<  Type of the onboard computer: 0: Mission computer primary, 1: Mission
                ...
                computers.
             */
    std::array<uint8_t, 8> cpu_cores; /*<  CPU usage on the component in percent (100 -
                idle). A value of UINT8_MAX implies the field is unused.
             */
    std::array<uint8_t, 10> cpu_combined; /*<  Combined CPU usage as the last 10 slices
             ...
             */
    std::array<uint8_t, 4> gpu_cores; /*<  GPU usage on the component in percent (100 -
                idle). A value of UINT8_MAX implies the field is unused.
             */
    std::array<uint8_t, 10> gpu_combined; /*<  Combined GPU usage as the last 10 slices
                of 100 MS (a histogram). This allows to identify spikes in load that max out the system, but only for a
                short amount of time. A value of UINT8_MAX implies the field is unused.
             */
    int8_t temperature_board; /*< [degC] Temperature of the board. A
             ...
             */
    std::array<int8_t, 8> temperature_core; /*< [degC] Temperature of the CPU
                core. A value of INT8_MAX implies the field is unused.
             */
    std::array<int16_t, 4> fan_speed; /*< [rpm] Fan speeds. A value of INT16_MAX
    ...
    uint32_t ram_total; /*< [MiB] Total amount of RAM on the
             ...
             */
    std::array<uint32_t, 4> storage_type; /*<  Storage type: 0: HDD, 1: SSD, 2: EMMC,
                3: SD card (non-removable), 4: SD card (removable). A value of UINT32_MAX implies the field is unused.
             */
    std::array<uint32_t, 4> storage_usage; /*< [MiB] Amount of used storage
                space on the component system. A value of UINT32_MAX implies the field is unused.
             */
    std::array<uint32_t, 4> storage_total; /*< [MiB] Total amount of storage
                space on the component system. A value of UINT32_MAX implies the field is unused.
             */
    std::array<uint32_t, 6> link_type; /*<  Link type: 0-9: UART, 10-19: Wired network, 20-29: Wifi, 30-39:
                Point-to-point proprietary, 40-49: Mesh proprietary
             */
    std::array<uint32_t, 6> link_tx_rate; /*< [KiB/s] Network traffic from the
                component system. A value of UINT32_MAX implies the field is unused.
             */
    std::array<uint32_t, 6> link_rx_rate; /*< [KiB/s] Network traffic to the
                component system. A value of UINT32_MAX implies the field is unused.
             */
    std::array<uint32_t, 6> link_tx_max; /*< [KiB/s] Network capacity from the
                component system. A value of UINT32_MAX implies the field is unused.
             */
    std::array<uint32_t, 6> link_rx_max; /*< [KiB/s] Network capacity to the
                component system. A value of UINT32_MAX implies the field is unused.
             */
