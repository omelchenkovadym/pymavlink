...
typedef struct __mavlink_follow_target_t {
 ...
 float acc[3]; /*< [m/s/s] linear target acceleration (0,0,0) for
                unknown
            */
 ...
 * @param acc [m/s/s] linear target acceleration (0,0,0) for
                unknown
 ...
 *
 * @return [m/s/s] linear target acceleration (0,0,0) for
                unknown
