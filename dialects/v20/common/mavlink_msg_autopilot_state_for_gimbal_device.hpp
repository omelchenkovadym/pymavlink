 ...
 * Low level message containing autopilot state relevant for a gimbal device. This message is to
                be sent from the autopilot to the gimbal device component. The data of this message are for the gimbal
...
struct AUTOPILOT_STATE_FOR_GIMBAL_DEVICE : mavlink::Message {
    ...
    std::array<float, 4> q; /*<  Quaternion components of autopilot attitude: w, x, y, z (1 0 0 0 is the
